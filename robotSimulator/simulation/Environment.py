...
from robotSimulator.representation.shapes import Point, Line
...
class Environment:
    ...
    def __init__(self,):
        ...
        # self.addObject(Object(Representation(Line(screenWidth,self.DEFAULT_BORDER_SCREEN_WIDTH,self.DEFAULT_BORDER_SCREEN_COLOR))),0,screenHeight-65,-90)
        # trouver comment récupérer la taille de la fenêtre PyQt
